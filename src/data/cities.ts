...
export const CITIES: CityData[] = [
  {
    ...
    seoTitle: "Ankara Motosiklet Yedek Parça — TVS Falcon Kargo ile",
    seoDescription: "Ankara'ya motosiklet yedek parçası kargoya veriyoruz. TVS, Falcon, Işıldar orijinal parçalar. Aynı gün kargo. WhatsApp sipariş: 0534 899 68 17",
    h1: "Ankara'ya Motosiklet Yedek Parça Kargo",
    intro: "İstanbul Fatih'teki Paşa Motor olarak Ankara ve tüm ilçelerine (Çankaya, Keçiören, Mamak, Yenimahalle) TVS, Falcon ve Işıldar orijinal yedek parçaları kargoya veriyoruz.",
  ...
  },
  {
    ...
    seoTitle: "İzmir Motosiklet Yedek Parça — TVS Falcon Orijinal Parça Kargo",
    seoDescription: "İzmir'e motosiklet yedek parçası kargo. TVS, Falcon orijinal parçalar. Konak, Bornova, Karşıyaka teslimat. WhatsApp: 0534 899 68 17",
    ...
    localInfo: "İzmir'de TVS, Falcon yetkili servis parçası arıyorsanız, İstanbul'dan WhatsApp ile kolayca sipariş verebilirsiniz.",
    faqs: [
  ...
  },
  {
    ...
    seoTitle: "Bursa Motosiklet Yedek Parça — Orijinal TVS Falcon Kargo",
    seoDescription: "Bursa'ya motosiklet yedek parçası kargo. Osmangazi, Nilüfer, Yıldırım teslimat. TVS Falcon orijinal parçalar. 0534 899 68 17",
    h1: "Bursa'ya Motosiklet Yedek Parça Kargo",
    intro: "Bursa ve çevre ilçelerine (Osmangazi, Nilüfer, Yıldırım, Mudanya) TVS, Falcon ve Işıldar orijinal parçaları kargoluyoruz.",
    ...
    faqs: [
      ...
      { question: "TVS Jupiter parçası Bursa'da var mı?", answer: "Paşa Motor'da TVS Jupiter tüm parçaları mevcuttur, Bursa'ya kargoluyoruz." },
  ...
  },
  {
    ...
    seoTitle: "Antalya Motosiklet Yedek Parça — TVS Falcon Kargo Aynı Gün",
    seoDescription: "Antalya'ya motosiklet yedek parçası kargo. Muratpaşa, Kepez, Alanya teslimat. TVS Falcon orijinal parça. WhatsApp: 0534 899 68 17",
  ...
  },
  {
    ...
    seoDescription: "Konya'ya TVS, Falcon motosiklet yedek parçası kargo. Selçuklu, Karatay, Meram teslimat. WhatsApp sipariş: 0534 899 68 17",
    h1: "Konya'ya Motosiklet Yedek Parça Kargo",
    intro: "Konya ve ilçelerine (Selçuklu, Karatay, Meram, Ereğli) TVS, Falcon ve Işıldar orijinal yedek parçaları kargoluyoruz.",
  ...
  },
  {
    ...
    seoTitle: "Adana Motosiklet Yedek Parça — TVS Falcon Kargo Teslimat",
    seoDescription: "Adana'ya motosiklet yedek parçası kargo. Seyhan, Yüreğir, Çukurova teslimat. TVS Falcon orijinal parça. 0534 899 68 17",
    h1: "Adana'ya Motosiklet Yedek Parça Kargo",
    intro: "Adana ve çevre ilçelerine TVS, Falcon ve Işıldar orijinal motosiklet yedek parçaları kargoluyoruz.",
  ...
  },
  {
    ...
    seoDescription: "Gaziantep'e TVS, Falcon yedek parça kargo. Şahinbey, Şehitkamil teslimat. Orijinal parça garantisi. WhatsApp: 0534 899 68 17",
    h1: "Gaziantep'e Motosiklet Yedek Parça Kargo",
    intro: "Gaziantep ve ilçelerine (Şahinbey, Şehitkamil, Nizip) TVS, Falcon ve Işıldar orijinal parçaları kargoluyoruz.",
    ...
    faqs: [
      ...
      { question: "TVS motosiklet parçası Gaziantep'te var mı?", answer: "Paşa Motor TVS yetkili servisidir, tüm TVS parçaları için kargo yapıyoruz." },
  ...
  },
  {
    ...
    seoDescription: "Kocaeli İzmit'e motosiklet yedek parçası. İstanbul'a yakınlık ile aynı gün kargo. TVS Falcon orijinal parça. 0534 899 68 17",
    h1: "Kocaeli'ye Motosiklet Yedek Parça — Hızlı Kargo",
  ...
  },
  {
    ...
    seoTitle: "Mersin Motosiklet Yedek Parça — TVS Falcon Kargo Teslimat",
    seoDescription: "Mersin'e motosiklet yedek parçası kargo. Yenişehir, Mezitli, Tarsus teslimat. Orijinal TVS Falcon parça. WhatsApp: 0534 899 68 17",
    h1: "Mersin'e Motosiklet Yedek Parça Kargo",
    intro: "Mersin ve ilçelerine (Yenişehir, Mezitli, Toroslar, Tarsus) TVS, Falcon ve Işıldar orijinal parçaları kargoluyoruz.",
