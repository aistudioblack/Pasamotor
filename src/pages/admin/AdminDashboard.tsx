      ...
      try {
        const postsToInject = [
          {
            ...
            cover_image: "/images/blog-cover-images/tvs-motosiklet-bakimi-servis-kapak.webp",
          ...
          },
          {
            ...
            cover_image: "/images/blog-cover-images/honda-pcx-scooter-varyator-kayis-degisimi-ve-bakimi-kapak.webp",
          ...
          },
          {
            ...
            cover_image: "/images/blog-cover-images/motosiklet-motor-yedek-parcalari-kapak.webp",
          ...
          },
          {
            ...
            cover_image: "/images/blog-cover-images/motosiklet-calismagidiyor-marz-basmiyor-elektrik-arizalari-kapak.webp",
          ...
          },
          {
            ...
            cover_image: "/images/blog-cover-images/falcon-motosiklet-servisi-bakim-kapak.webp",
          ...
          },
          {
            ...
            cover_image: "/images/blog-cover-images/kurye-motoru-elektrik-arizalari-kapak.webp",
          ...
          },
          {
            ...
            cover_image: "/images/blog-cover-images/istanbul-scooter-servisi-kayis-varyator-bakimi-kapak.webp",
        ...
        for (const post of postsToInject) {
          ...
          if (!existing || existing.length === 0) {
            ...
            await dbClient.from('posts').update({ cover_image: post.cover_image }).eq('slug', post.slug);
          }
        }

        // Veritabanındaki diğer tüm kapak resimlerinden pollinations.ai içerenleri temizle
        const { data: allPosts } = await dbClient.from('posts').select('id, cover_image');
        if (allPosts) {
          for (const p of allPosts) {
            if (p.cover_image && p.cover_image.includes('pollinations.ai')) {
              await dbClient.from('posts').update({ cover_image: "" }).eq('id', p.id);
            }
          }
        }
      } catch (e) {
