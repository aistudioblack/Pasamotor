...
const Hakkimizda = () => {
  const seo = useSEO(
    "hakkimizda",
    "Hakkımızda - 20+ Yıllık Motosiklet Deneyimi",
    "Paşa Motor, İstanbul Fatih'te 20+ yıldır TVS, Hero, Falcon ve Işıldar markalarının yetkili bayisi. Nihat KAN liderliğinde motosiklet satış, servis ve yedek parça hizmeti."
  );
