...
const Blog = () => {
  ...
  const seo = useSEO(
    "blog",
    "Blog - Motosiklet Bakım İpuçları ve Sektör Haberleri",
    "Paşa Motor blog: motosiklet bakım rehberleri, TVS, Hero, Falcon, Işıldar model incelemeleri, periyodik bakım ipuçları ve sektör haberleri."
  );
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                      ...
                      <span className="mt-auto inline-flex items-center gap-2 text-primary font-bold text-sm bg-primary/10 w-fit px-4 py-2 rounded-lg group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300">
                        Yazıyı Oku
