...
const Iletisim = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Paşa Motor İletişim — Fatih Kızılelma Caddesi No:66 İstanbul"
        description="Kızılelma Cd. No:66 Fatih/İstanbul. Tel: 0212 586 85 98 Hafta içi 09:00-19:00, Cumartesi 09:00-17:00."
        canonical="/iletisim"
