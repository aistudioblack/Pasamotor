...
const YedekParca = () => {
  ...
  const [isPhotoFinderOpen, setIsPhotoFinderOpen] = useState(false);
  ...
  return (
    <Layout>
            ...
            <aside className="hidden lg:block lg:col-span-1 space-y-6">
              <div className="glass-card rounded-2xl border border-border/40 p-6 sticky top-24 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setIsPhotoFinderOpen(true)}
                    className="w-full mt-1.5 py-2.5 rounded-xl bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 font-bold text-xs flex items-center justify-center gap-2 shadow-sm transition"
                  >
                    <Camera className="w-4 h-4 animate-pulse" />
                    📸 Fotoğraftan Parça Tespiti (AI OCR)
                  </button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setIsPhotoFinderOpen(true);
                    }}
                    className="w-full mt-1.5 py-2 rounded-xl bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 font-bold text-xs flex items-center justify-center gap-1.5 shadow-sm transition"
                  >
      ...
      <PhotoPartFinderModal
        isOpen={isPhotoFinderOpen}
        onClose={() => setIsPhotoFinderOpen(false)}
