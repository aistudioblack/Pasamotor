...
const defaultServices: Service[] = [
  {
    ...
    description: "TVS, Falcon, Işıldar ve Moto Lux markalarının en güncel modellerini showroom'umuzda inceleyebilirsiniz. Kredi ve taksit seçenekleri mevcuttur.",
    link: "/hizmetler",
  },
  {
    iconName: "Wrench",
