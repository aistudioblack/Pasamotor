...
const faqs = [
  ...
  },
  {
    ...
    answer: "İnternet sitemizdeki İletişim sayfasından formu doldurarak veya doğrudan müşteri hizmetlerimizi arayarak servis randevusu oluşturabilirsiniz.",
    category: "Servis Hizmetleri",
    is_active: true,
    sort_order: 5,
    created_at: new Date().toISOString()
  },
  {
    ...
    answer: "Orijinal parçalar üretici firmanın garanti kapsamındadır ve motosikletinizin ömrünü uzatır. Yan sanayi parçalar daha uygun maliyetli olsa da kalite standartları orijinalini tutmaz. Biz orijinal kullanımı öneriyoruz.",
    category: "Yedek Parça",
    is_active: true,
    sort_order: 6,
    created_at: new Date().toISOString()
